...
export class KardexComponent implements OnInit {
  ...
  public kardex: Compra[] = [];
  public dataKardex: Array<data> = [];
  dataSourceKardex!: MatTableDataSource<data>;
  // Cateria, Subcateria, Codi, Producto, Unid_Med, Entradas, Salidas, Stock
  displayedColumnsKardex: string[] = ['index', 'Categoria', 'Subcategoria', 'Codigo', 'Producto', 'Unidad de Medida', 'Entradas', 'Salidas', 'Stock'];
  ...
  GetListaKardex(){
    this.entradaService.getKardexMat().subscribe((datos: string | Compra) => {
      this.kardex = datos as unknown as Compra[];
      this.dataKardex = datos['data'];
      this.dataSourceKardex = new MatTableDataSource<data>(this.dataKardex);
  ...
  applyFilter(event) {
    ...
    this.dataSourceKardex.filter = filterValue;
  }
