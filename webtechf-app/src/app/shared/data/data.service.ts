...
export class DataService {
  ...
  public getRolList(): Observable<apiResultFormat> {
    return this.http.get<apiResultFormat>('assets/json/rol-list.json').pipe(
      ...
      menu: [
        {
          ...
          subMenus: [
            ...
            {
              menuValue: 'Listado de Roles',
              route: routes.listadoRole,
              base: routes.listadoRole,
              permision: 'lista-roles',
              show_nav: true,
            },          
          ],
        },
        {
          ...
          subMenus: [
            {
              menuValue: 'Categorias',
              route: routes.listadoCategorias,
              base: routes.listadoCategorias,
              permision: 'listar-categoria',
              show_nav: true,
            },  
            {
              menuValue: 'Crear Categorias',
              route: routes.CrearCategorias,
              base: routes.CrearCategorias,
              permision: 'crear-categoria',
              show_nav: true,
            },
            {
              menuValue: 'Editar Categoria',
              route: routes.EditarCategorias,
              base: routes.EditarCategorias,
              permision: 'editar-categoria',
              show_nav: true,
            }        
          ],
        },
        {
          menuValue: 'SubCategorias',
          hasSubRoute: true,
          showSubRoute: false,
          base: 'dashboard',
          route:'dashboard',
          img: 'assets/img/icons/tag-icon-04.svg',
          subMenus: [
            {
              menuValue: 'SubCategorias',
              route: routes.listadoSubcategorias,
              base: routes.listadoSubcategorias,
              permision: 'listar-subcategorias',
              show_nav: true,
            },
            {
              menuValue: 'Crear-SubCategorias',
              route: routes.CrearSubcategorias,
              base: routes.CrearSubcategorias,
              permision: 'crear-subcategorias',
              show_nav: true,
            }, 
            {
              menuValue: 'Editar-Categorias',
              route: routes.EditarSubcategorias,
              base: routes.EditarSubcategorias,
              permision: 'editar-subcategorias',
              show_nav: true,
            },          
          ],
        },
        {
          ...
          subMenus: [
            {
              menuValue: 'Productos',
              route: routes.listadoProductos,
              base: routes.listadoProductos,
              permision: 'listar-producto',
              show_nav: true,
            }, 
            {
              menuValue: 'Entrada Productos',
              route: routes.entradaProductos,
              base: routes.entradaProductos,
              permision: 'entrada-productos',
              show_nav: true,
            },
            {
              menuValue: 'Lista Compras',
              route: routes.ListaCompras,
              base: routes.ListaCompras,
              permision: 'lista-compras',
              show_nav: true,
            },
            {
              menuValue: 'Salida Productos',
              route: routes.salidaProductos,
              base: routes.salidaProductos,
              permision: 'salida-productos',
              show_nav: true,
            },
            {
              menuValue: 'Kardex',
        ...
        },
        {
          ...
          subMenus: [
            {
              menuValue: 'Proveedores',
              route: routes.listadoProveedores,
              base: routes.listadoProveedores,
              permision: 'listar-proveedor',
              show_nav: true,
            }, 
            {
              menuValue: 'Crear Proveedor',
              route: routes.CrearProveedores,
              base: routes.CrearProveedores,
              permision: 'crear-proveedor',
              show_nav: true,
            },
            {
              menuValue: 'Editar Proveedor',
              route: routes.EditarProveedores,
              base: routes.EditarProveedores,
              permision: 'editar-proveedor',
              show_nav: true,
            },        
          ],
        },
        {
          ...
          subMenus: [
            {
              menuValue: 'Rutas-Robot',
              route: routes.RutaRobot,
              base: routes.RutaRobot,
              permision: 'ruta-robot',
              show_nav: true,
            },         
          ],
        },
