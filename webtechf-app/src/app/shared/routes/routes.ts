export class routes {
  ...
  // primero la ruta despues el path
  public static get registerRole(): string {
    return this.baseUrl + '/roles/register';
  }
  public static get listadoRole(): string {
    return this.baseUrl + '/roles/lista-roles';
  }
  public static get editarRole(): string {
    return this.baseUrl + '/roles/editar-roles';
  }
  // Productos
  public static get listadoProductos(): string {
    return this.baseUrl + '/productos/ListaProductos';
  }

  public static get entradaProductos(): string {
    return this.baseUrl + '/productos/entrada-productos';
  }

  public static get salidaProductos(): string {
    return this.baseUrl + '/productos/salida-productos';
  }

  public static get kardex(): string {
    return this.baseUrl + '/productos/kardex';
  }

  public static get ListaCompras(): string {
    return this.baseUrl + '/productos/lista-compras';
  }

  // Proveedores
  public static get listadoProveedores(): string {
    return this.baseUrl + '/proveedores/ListaProveedores';
  }
  public static get CrearProveedores(): string {
    return this.baseUrl + '/proveedores/crear-proveedor';
  }
  public static get EditarProveedores(): string {
    return this.baseUrl + '/proveedores/editar-proveedor';
  }
  // Clientes
  // Categorias
  public static get listadoCategorias(): string {
    return this.baseUrl + '/categoria/ListaCategoria';
  }
  public static get CrearCategorias(): string {
    return this.baseUrl + '/categoria/CrearCategoria';
  }
  public static get EditarCategorias(): string {
    return this.baseUrl + '/categoria/EditarCategoria';
  }
  // Subcategorias
  public static get listadoSubcategorias(): string {
    return this.baseUrl + '/subcategoria/ListaSubcategoria';
  }
  public static get CrearSubcategorias(): string {
    return this.baseUrl + '/subcategoria/CrearSubcategoria';
  }
  public static get EditarSubcategorias(): string {
    return this.baseUrl + '/subcategoria/Editar-Subcategoria';
  }
  // Rutas-Robot
  public static get RutaRobot(): string {
    return this.baseUrl + '/ruta/rutas-robot';
  }
}
